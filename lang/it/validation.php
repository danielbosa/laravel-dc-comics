    ...
    */
    ...
    'custom' => [
        'title' => [
            ...
            'max' => 'Il titolo non può superare i 255 caratteri',
        ],
        'description' => [
        ...
        'price' => [
            'numeric' => 'Inserisci un valore numerico',
        ],
        'series' => [
            'required' => 'Il nome della serie è obbligatorio',
            'max' => 'Il nome della serie non può superare i 255 caratteri',
        ],
        'sale_date' => [
            'required' => 'La data di vendita è obbligatoria',
            'date' => 'La data di vendita non è una data valida',
        ],
        'type' => [
            'required' => 'Il tipo è obbligatorio',
            'max' => 'Il tipo non può superare i 255 caratteri',
        ],
    ],
